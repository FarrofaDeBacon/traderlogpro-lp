...
<section class="relative pt-44 pb-24 px-6 overflow-hidden max-w-6xl mx-auto w-full">
    <div class="grid lg:grid-cols-12 gap-12 items-center">
        <div class="lg:col-span-6 space-y-8 text-center lg:text-left">
            {#if visible}
                ...
                <p in:fly={{ y: 20, duration: 800, delay: 400 }} class="text-lg text-slate-400 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                    Transforme seus trades em dados e evolua com consistência através do diário de trade do TraderLogPro.
                </p>

                <div in:fly={{ y: 20, duration: 800, delay: 600 }} class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                    <a href="#pricing" class="w-full sm:w-auto bg-emerald-500 hover:bg-emerald-400 text-slate-950 px-10 py-4.5 rounded-2xl text-[12px] font-black uppercase tracking-widest transition-all shadow-2xl shadow-emerald-500/40 flex items-center justify-center gap-3 active:scale-95 cursor-pointer select-none">
                        Começar Agora
